...
# python train_wm_select.py --train_sac_chunked_wm.general.env_name=cube-triple-play-singletask-v0
# control run (world model unused for selection):
# python train_wm_select.py --train_sac_chunked_wm.chunk.select_n=1