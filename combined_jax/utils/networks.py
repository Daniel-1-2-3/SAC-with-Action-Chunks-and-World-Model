# COMBINED PATCH: verbatim from ColinQiyangLi/qc@48283b4 utils/networks.py
# minus the distrax-dependent classes (TransformedWithMode, Actor), which
# acfql.py never uses -- deletions only, nothing kept here is modified.
