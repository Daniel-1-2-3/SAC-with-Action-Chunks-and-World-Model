...
# python train_wm_dyna.py --train_sac_chunked_wm.general.env_name=cube-triple-play-singletask-v0
# control run (world model unused for critic data):
# python train_wm_dyna.py --train_sac_chunked_wm.chunk.dyna_batch=0