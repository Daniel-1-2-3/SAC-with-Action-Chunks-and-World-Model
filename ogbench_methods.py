...
class OGBenchMethods:
    ...
    def make_dreamer_episodes(
        ...
        transition_episodes = OGBenchMethods.flat_dataset_to_episodes(dataset)
        dreamer_episodes = []
        for ep in transition_episodes:
            dreamer_ep = OGBenchMethods.ogbench_to_dreamer_episode(ep, obs_key=obs_key, action_key=action_key)
