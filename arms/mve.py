""" MVE arm -- model value expansion, value-only.
    ...
    the model's value sits ~0.56 * head spread below the critic's on every
        ...
        with torch.no_grad():
            ...
            if metrics_on:
                ...
                self._target_stats = {
                    ...
                    # With chunk_boot_agg=mean this should sit near 0; the
                    # 'min' rule drove it to -0.5 in t4_mve_s0.
